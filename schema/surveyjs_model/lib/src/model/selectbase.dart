...
abstract class Selectbase implements Question, SelectbaseAllOf {
  @BuiltValueSerializer(custom: true)
  static Serializer<Selectbase> get serializer => _$SelectbaseSerializer();
}

class _$SelectbaseSerializer implements PrimitiveSerializer<Selectbase> {
  @override
  final Iterable<Type> types = const [Selectbase];

  @override
  final String wireName = r'Selectbase';
  ...
  @override
  Selectbase deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    return serializers.deserialize(serialized, specifiedType: FullType($Selectbase)) as $Selectbase;
  }
}

/// a concrete implementation of [Selectbase], since [Selectbase] is not instantiable
@BuiltValue(instantiable: true)
abstract class $Selectbase implements Selectbase, Built<$Selectbase, $SelectbaseBuilder> {
  $Selectbase._();

  factory $Selectbase([void Function($SelectbaseBuilder)? updates]) = _$$Selectbase;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults($SelectbaseBuilder b) => b;
...
class _$$SelectbaseSerializer implements PrimitiveSerializer<$Selectbase> {
  @override
  final Iterable<Type> types = const [$Selectbase, _$$Selectbase];
  ...
  Object serialize(
    ...
    return serializers.serialize(object, specifiedType: FullType(Selectbase))!;
  }
  ...
  void _deserializeProperties(
    ...
    required SelectbaseBuilder result,
  ...
  $Selectbase deserialize(
    ...
    final result = $SelectbaseBuilder();
