...
/// * [commentPlaceholder] 
@BuiltValue()
abstract class Empty implements Question, Built<Empty, EmptyBuilder> {
  Empty._();

  factory Empty([void updates(EmptyBuilder b)]) = _$Empty;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(EmptyBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<Empty> get serializer => _$EmptySerializer();
}

class _$EmptySerializer implements PrimitiveSerializer<Empty> {
  @override
