...
abstract class Buttongroup implements Checkboxbase, Built<Buttongroup, ButtongroupBuilder> {
  ...
  static void _defaults(ButtongroupBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<Buttongroup> get serializer => _$ButtongroupSerializer();
}

class _$ButtongroupSerializer implements PrimitiveSerializer<Buttongroup> {
  @override
  final Iterable<Type> types = const [Buttongroup, _$Buttongroup];

  @override
  final String wireName = r'Buttongroup';
  ...
  void _deserializeProperties(
    ...
    required ButtongroupBuilder result,
  ...
  @override
  Buttongroup deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ButtongroupBuilder();
