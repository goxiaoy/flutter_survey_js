...
abstract class Html implements HtmlconditionitemAllOf, Nonvalue, Built<Html, HtmlBuilder> {
  ...
  static void _defaults(HtmlBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<Html> get serializer => _$HtmlSerializer();
}

class _$HtmlSerializer implements PrimitiveSerializer<Html> {
  @override
  final Iterable<Type> types = const [Html, _$Html];

  @override
  final String wireName = r'Html';
