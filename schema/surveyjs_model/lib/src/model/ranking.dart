...
abstract class Ranking implements Checkbox, RankingAllOf, Built<Ranking, RankingBuilder> {
  ...
  static void _defaults(RankingBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<Ranking> get serializer => _$RankingSerializer();
}

class _$RankingSerializer implements PrimitiveSerializer<Ranking> {
  @override
  final Iterable<Type> types = const [Ranking, _$Ranking];

  @override
  final String wireName = r'Ranking';
  ...
  void _deserializeProperties(
    ...
    required RankingBuilder result,
