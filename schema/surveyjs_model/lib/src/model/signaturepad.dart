...
/// * [dataFormat] 
@BuiltValue()
abstract class Signaturepad implements Question, SignaturepadAllOf, Built<Signaturepad, SignaturepadBuilder> {
  Signaturepad._();

  factory Signaturepad([void updates(SignaturepadBuilder b)]) = _$Signaturepad;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SignaturepadBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<Signaturepad> get serializer => _$SignaturepadSerializer();
}

class _$SignaturepadSerializer implements PrimitiveSerializer<Signaturepad> {
  @override
  final Iterable<Type> types = const [Signaturepad, _$Signaturepad];

  @override
  final String wireName = r'Signaturepad';
  ...
  void _deserializeProperties(
    ...
    required SignaturepadBuilder result,
  ...
  @override
  Signaturepad deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = SignaturepadBuilder();
