...
abstract class Multipletext implements MultipletextAllOf, Question, Built<Multipletext, MultipletextBuilder> {
  ...
  static void _defaults(MultipletextBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<Multipletext> get serializer => _$MultipletextSerializer();
}

class _$MultipletextSerializer implements PrimitiveSerializer<Multipletext> {
  @override
  final Iterable<Type> types = const [Multipletext, _$Multipletext];

  @override
  final String wireName = r'Multipletext';
  ...
  void _deserializeProperties(
    ...
    required MultipletextBuilder result,
  ...
  @override
  Multipletext deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = MultipletextBuilder();
