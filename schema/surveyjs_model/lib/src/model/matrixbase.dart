...
class _$MatrixbaseSerializer implements PrimitiveSerializer<Matrixbase> {
  @override
  final Iterable<Type> types = const [Matrixbase];

  @override
  final String wireName = r'Matrixbase';
  ...
  @override
  Matrixbase deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    return serializers.deserialize(serialized, specifiedType: FullType($Matrixbase)) as $Matrixbase;
  }
}

/// a concrete implementation of [Matrixbase], since [Matrixbase] is not instantiable
@BuiltValue(instantiable: true)
abstract class $Matrixbase implements Matrixbase, Built<$Matrixbase, $MatrixbaseBuilder> {
  $Matrixbase._();

  factory $Matrixbase([void Function($MatrixbaseBuilder)? updates]) = _$$Matrixbase;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults($MatrixbaseBuilder b) => b;
...
class _$$MatrixbaseSerializer implements PrimitiveSerializer<$Matrixbase> {
  @override
  final Iterable<Type> types = const [$Matrixbase, _$$Matrixbase];
  ...
  Object serialize(
    ...
    return serializers.serialize(object, specifiedType: FullType(Matrixbase))!;
  }
  ...
  void _deserializeProperties(
    ...
    required MatrixbaseBuilder result,
  ...
  $Matrixbase deserialize(
    ...
    final result = $MatrixbaseBuilder();
