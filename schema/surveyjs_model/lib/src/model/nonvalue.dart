...
abstract class Nonvalue implements NonvalueAllOf, Question {
  @BuiltValueSerializer(custom: true)
  static Serializer<Nonvalue> get serializer => _$NonvalueSerializer();
}

class _$NonvalueSerializer implements PrimitiveSerializer<Nonvalue> {
  @override
  final Iterable<Type> types = const [Nonvalue];

  @override
  final String wireName = r'Nonvalue';
  ...
  @override
  Nonvalue deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    return serializers.deserialize(serialized, specifiedType: FullType($Nonvalue)) as $Nonvalue;
  }
}

/// a concrete implementation of [Nonvalue], since [Nonvalue] is not instantiable
@BuiltValue(instantiable: true)
abstract class $Nonvalue implements Nonvalue, Built<$Nonvalue, $NonvalueBuilder> {
  $Nonvalue._();

  factory $Nonvalue([void Function($NonvalueBuilder)? updates]) = _$$Nonvalue;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults($NonvalueBuilder b) => b;
...
class _$$NonvalueSerializer implements PrimitiveSerializer<$Nonvalue> {
  @override
  final Iterable<Type> types = const [$Nonvalue, _$$Nonvalue];
  ...
  Object serialize(
    ...
    return serializers.serialize(object, specifiedType: FullType(Nonvalue))!;
  }
  ...
  void _deserializeProperties(
    ...
    required NonvalueBuilder result,
