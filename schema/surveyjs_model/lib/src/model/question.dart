...
class _$QuestionSerializer implements PrimitiveSerializer<Question> {
  @override
  final Iterable<Type> types = const [Question];
  ...
  Question deserialize(
    ...
    return serializers.deserialize(serialized, specifiedType: FullType($Question)) as $Question;
  }
}

/// a concrete implementation of [Question], since [Question] is not instantiable
@BuiltValue(instantiable: true)
abstract class $Question implements Question, Built<$Question, $QuestionBuilder> {
  $Question._();
...
class _$$QuestionSerializer implements PrimitiveSerializer<$Question> {
  ...
  Object serialize(
    ...
    return serializers.serialize(object, specifiedType: FullType(Question))!;
  }
