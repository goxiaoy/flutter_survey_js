...
part 'matrixdropdownbase.g.dart';
...
abstract class Matrixdropdownbase implements Matrixbase, MatrixdropdownbaseAllOf {
  @BuiltValueSerializer(custom: true)
  static Serializer<Matrixdropdownbase> get serializer => _$MatrixdropdownbaseSerializer();
}

class _$MatrixdropdownbaseSerializer implements PrimitiveSerializer<Matrixdropdownbase> {
  @override
  final Iterable<Type> types = const [Matrixdropdownbase];

  @override
  final String wireName = r'Matrixdropdownbase';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    Matrixdropdownbase object, {
  ...
  @override
  Matrixdropdownbase deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    return serializers.deserialize(serialized, specifiedType: FullType($Matrixdropdownbase)) as $Matrixdropdownbase;
  }
}

/// a concrete implementation of [Matrixdropdownbase], since [Matrixdropdownbase] is not instantiable
@BuiltValue(instantiable: true)
abstract class $Matrixdropdownbase implements Matrixdropdownbase, Built<$Matrixdropdownbase, $MatrixdropdownbaseBuilder> {
  $Matrixdropdownbase._();

  factory $Matrixdropdownbase([void Function($MatrixdropdownbaseBuilder)? updates]) = _$$Matrixdropdownbase;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults($MatrixdropdownbaseBuilder b) => b;
...
class _$$MatrixdropdownbaseSerializer implements PrimitiveSerializer<$Matrixdropdownbase> {
  @override
  final Iterable<Type> types = const [$Matrixdropdownbase, _$$Matrixdropdownbase];
  ...
  Object serialize(
    ...
    return serializers.serialize(object, specifiedType: FullType(Matrixdropdownbase))!;
  }
  ...
  void _deserializeProperties(
    ...
    required MatrixdropdownbaseBuilder result,
  ...
  $Matrixdropdownbase deserialize(
    ...
    final result = $MatrixdropdownbaseBuilder();
