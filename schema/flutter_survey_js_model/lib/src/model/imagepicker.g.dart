...
class _$Imagepicker extends Imagepicker {
  ...
  factory _$Imagepicker([void Function(ImagepickerBuilder)? updates]) =>
      (new ImagepickerBuilder()..update(updates))._build();
  ...
  @override
  Imagepicker rebuild(void Function(ImagepickerBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  ImagepickerBuilder toBuilder() => new ImagepickerBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is Imagepicker &&
        optionsCaption == other.optionsCaption &&
  ...
  int get hashCode {
    var _$hash = 0;
    _$hash = $jc(_$hash, optionsCaption.hashCode);
    _$hash = $jc(_$hash, imageWidth.hashCode);
    _$hash = $jc(_$hash, maxImageHeight.hashCode);
    _$hash = $jc(_$hash, imageFit.hashCode);
    _$hash = $jc(_$hash, minImageWidth.hashCode);
    _$hash = $jc(_$hash, maxImageWidth.hashCode);
    _$hash = $jc(_$hash, contentMode.hashCode);
    _$hash = $jc(_$hash, minImageHeight.hashCode);
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'Imagepicker')
          ..add('optionsCaption', optionsCaption)
          ..add('imageWidth', imageWidth)
          ..add('maxImageHeight', maxImageHeight)
          ..add('imageFit', imageFit)
          ..add('minImageWidth', minImageWidth)
          ..add('maxImageWidth', maxImageWidth)
          ..add('contentMode', contentMode)
          ..add('minImageHeight', minImageHeight)
...
class ImagepickerBuilder
    implements Builder<Imagepicker, ImagepickerBuilder>, CheckboxbaseBuilder {
  _$Imagepicker? _$v;

  String? _optionsCaption;
  String? get optionsCaption => _$this._optionsCaption;
  ...
  ImagepickerImageFit? get imageFit => _$this._imageFit;
  ...
  ImagepickerContentMode? get contentMode => _$this._contentMode;
  ...
  set showLabel(covariant bool? showLabel) => _$this._showLabel = showLabel;
  ...
  ImagepickerBuilder() {
    Imagepicker._defaults(this);
  }

  ImagepickerBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(covariant Imagepicker other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$Imagepicker;
  }

  @override
  void update(void Function(ImagepickerBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  Imagepicker build() => _build();

  _$Imagepicker _build() {
    _$Imagepicker _$result;
    try {
      _$result = _$v ??
          new _$Imagepicker._(
