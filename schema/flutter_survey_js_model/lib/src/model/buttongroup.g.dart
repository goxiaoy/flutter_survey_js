...
class _$Buttongroup extends Buttongroup {
  ...
  factory _$Buttongroup([void Function(ButtongroupBuilder)? updates]) =>
  ...
  @override
  Buttongroup rebuild(void Function(ButtongroupBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  ButtongroupBuilder toBuilder() => new ButtongroupBuilder()..replace(this);
...
class ButtongroupBuilder
  ...
  @override
  void update(void Function(ButtongroupBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  Buttongroup build() => _build();

  _$Buttongroup _build() {
    _$Buttongroup _$result;
    try {
      _$result = _$v ??
          new _$Buttongroup._(
              colCount: colCount,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'Buttongroup', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
