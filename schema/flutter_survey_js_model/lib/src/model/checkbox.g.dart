...
abstract class CheckboxBuilder implements CheckboxbaseBuilder {
  void replace(covariant Checkbox other);
...
class _$$Checkbox extends $Checkbox {
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'$Checkbox')
...
class $CheckboxBuilder
    implements Builder<$Checkbox, $CheckboxBuilder>, CheckboxBuilder {
  _$$Checkbox? _$v;
