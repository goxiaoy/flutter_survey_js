...
class _$Matrixdropdown extends Matrixdropdown {
  ...
  factory _$Matrixdropdown([void Function(MatrixdropdownBuilder)? updates]) =>
      (new MatrixdropdownBuilder()..update(updates))._build();
  ...
  @override
  Matrixdropdown rebuild(void Function(MatrixdropdownBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  MatrixdropdownBuilder toBuilder() =>
      new MatrixdropdownBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is Matrixdropdown &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'Matrixdropdown')
...
class MatrixdropdownBuilder
    implements
        Builder<Matrixdropdown, MatrixdropdownBuilder>,
        MatrixdropdownbaseBuilder {
  _$Matrixdropdown? _$v;

  SurveyTitleBuilder? _totalText;
  SurveyTitleBuilder get totalText =>
      _$this._totalText ??= new SurveyTitleBuilder();
  set totalText(covariant SurveyTitleBuilder? totalText) =>
      _$this._totalText = totalText;
  ...
  MatrixdropdownBuilder() {
    Matrixdropdown._defaults(this);
  }

  MatrixdropdownBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _totalText = $v.totalText?.toBuilder();
  ...
  @override
  void replace(covariant Matrixdropdown other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$Matrixdropdown;
  }

  @override
  void update(void Function(MatrixdropdownBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  Matrixdropdown build() => _build();

  _$Matrixdropdown _build() {
    _$Matrixdropdown _$result;
    try {
      _$result = _$v ??
          new _$Matrixdropdown._(
              totalText: _totalText?.build(),
              rows: _rows?.build(),
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'Matrixdropdown', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
