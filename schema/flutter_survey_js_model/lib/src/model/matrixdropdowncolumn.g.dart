...
class _$Matrixdropdowncolumn extends Matrixdropdowncolumn {
  ...
  @override
  final SurveyTitle? labelTrue;
  @override
  final SurveyTitle? labelFalse;
  @override
  final SurveyTitle? label;
  @override
  ...
  final String? name;
  @override
  final SurveyTitle? selectAllText;
  @override
  ...
  @override
  final SurveyTitle? otherText;
  @override
  final BuiltList<MatrixdropdownbaseAllOfChoicesInner>? choices;
  @override
  final bool? showNoneItem;
  @override
  final SurveyTitle? otherErrorText;
  @override
  ...
  bool operator ==(Object other) {
    ...
    return other is Matrixdropdowncolumn &&
        ...
        minSelectedChoices == other.minSelectedChoices &&
  ...
  int get hashCode {
    ...
    _$hash = $jc(_$hash, minSelectedChoices.hashCode);
  ...
  String toString() {
    return (newBuiltValueToStringHelper(r'Matrixdropdowncolumn')
          ...
          ..add('minSelectedChoices', minSelectedChoices)
...
class MatrixdropdowncolumnBuilder
    implements
        Builder<Matrixdropdowncolumn, MatrixdropdowncolumnBuilder>,
        BooleanBuilder,
        CheckboxBuilder,
        CommentBuilder,
        DropdownBuilder,
  ...
  SurveyTitleBuilder? _cellHint;
  SurveyTitleBuilder get cellHint =>
      _$this._cellHint ??= new SurveyTitleBuilder();
  set cellHint(covariant SurveyTitleBuilder? cellHint) =>
      _$this._cellHint = cellHint;

  String? _totalExpression;
  String? get totalExpression => _$this._totalExpression;
  set totalExpression(covariant String? totalExpression) =>
  ...
  set cellType(covariant MatrixdropdowncolumnCellType? cellType) =>
  ...
  set totalMaximumFractionDigits(covariant num? totalMaximumFractionDigits) =>
  ...
  set totalMinimumFractionDigits(covariant num? totalMinimumFractionDigits) =>
  ...
  set showInMultipleColumns(covariant bool? showInMultipleColumns) =>
      _$this._showInMultipleColumns = showInMultipleColumns;

  bool? _isUnique;
  bool? get isUnique => _$this._isUnique;
  set isUnique(covariant bool? isUnique) => _$this._isUnique = isUnique;

  SurveyTitleBuilder? _totalFormat;
  SurveyTitleBuilder get totalFormat =>
      _$this._totalFormat ??= new SurveyTitleBuilder();
  set totalFormat(covariant SurveyTitleBuilder? totalFormat) =>
      _$this._totalFormat = totalFormat;

  MatrixdropdowncolumnTotalType? _totalType;
  MatrixdropdowncolumnTotalType? get totalType => _$this._totalType;
  set totalType(covariant MatrixdropdowncolumnTotalType? totalType) =>
  ...
  set totalCurrency(
          covariant MatrixdropdowncolumnTotalCurrency? totalCurrency) =>
  ...
  set totalDisplayStyle(
          covariant MatrixdropdowncolumnTotalDisplayStyle? totalDisplayStyle) =>
  ...
  SurveyTitleBuilder? _labelTrue;
  SurveyTitleBuilder get labelTrue =>
      _$this._labelTrue ??= new SurveyTitleBuilder();
  set labelTrue(covariant SurveyTitleBuilder? labelTrue) =>
      _$this._labelTrue = labelTrue;

  SurveyTitleBuilder? _labelFalse;
  SurveyTitleBuilder get labelFalse =>
      _$this._labelFalse ??= new SurveyTitleBuilder();
  set labelFalse(covariant SurveyTitleBuilder? labelFalse) =>
      _$this._labelFalse = labelFalse;

  SurveyTitleBuilder? _label;
  SurveyTitleBuilder get label => _$this._label ??= new SurveyTitleBuilder();
  set label(covariant SurveyTitleBuilder? label) => _$this._label = label;
  ...
  SurveyTitleBuilder? _selectAllText;
  SurveyTitleBuilder get selectAllText =>
      _$this._selectAllText ??= new SurveyTitleBuilder();
  set selectAllText(covariant SurveyTitleBuilder? selectAllText) =>
  ...
  num? _minSelectedChoices;
  num? get minSelectedChoices => _$this._minSelectedChoices;
  set minSelectedChoices(covariant num? minSelectedChoices) =>
      _$this._minSelectedChoices = minSelectedChoices;
  ...
  ChoicesByUrlBuilder? _choicesByUrl;
  ChoicesByUrlBuilder get choicesByUrl =>
      _$this._choicesByUrl ??= new ChoicesByUrlBuilder();
  set choicesByUrl(covariant ChoicesByUrlBuilder? choicesByUrl) =>
  ...
  SurveyTitleBuilder? _noneText;
  SurveyTitleBuilder get noneText =>
      _$this._noneText ??= new SurveyTitleBuilder();
  set noneText(covariant SurveyTitleBuilder? noneText) =>
      _$this._noneText = noneText;
  ...
  SurveyTitleBuilder? _otherPlaceholder;
  SurveyTitleBuilder get otherPlaceholder =>
      _$this._otherPlaceholder ??= new SurveyTitleBuilder();
  set otherPlaceholder(covariant SurveyTitleBuilder? otherPlaceholder) =>
  ...
  SurveyTitleBuilder? _otherText;
  SurveyTitleBuilder get otherText =>
      _$this._otherText ??= new SurveyTitleBuilder();
  set otherText(covariant SurveyTitleBuilder? otherText) =>
      _$this._otherText = otherText;

  ListBuilder<MatrixdropdownbaseAllOfChoicesInner>? _choices;
  ListBuilder<MatrixdropdownbaseAllOfChoicesInner> get choices =>
      _$this._choices ??=
          new ListBuilder<MatrixdropdownbaseAllOfChoicesInner>();
  set choices(
          covariant ListBuilder<MatrixdropdownbaseAllOfChoicesInner>?
              choices) =>
  ...
  SurveyTitleBuilder? _otherErrorText;
  SurveyTitleBuilder get otherErrorText =>
      _$this._otherErrorText ??= new SurveyTitleBuilder();
  set otherErrorText(covariant SurveyTitleBuilder? otherErrorText) =>
  ...
  MatrixdropdowncolumnBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _cellHint = $v.cellHint?.toBuilder();
      ...
      _totalFormat = $v.totalFormat?.toBuilder();
      ...
      _labelTrue = $v.labelTrue?.toBuilder();
      _labelFalse = $v.labelFalse?.toBuilder();
      ...
      _noneText = $v.noneText?.toBuilder();
      _choicesOrder = $v.choicesOrder;
      _separateSpecialChoices = $v.separateSpecialChoices;
      _otherPlaceholder = $v.otherPlaceholder?.toBuilder();
      ...
      _otherText = $v.otherText?.toBuilder();
      _choices = $v.choices?.toBuilder();
      _showNoneItem = $v.showNoneItem;
      _otherErrorText = $v.otherErrorText?.toBuilder();
...
// ignore: override_on_non_overriding_method
  void replace(covariant Matrixdropdowncolumn other) {
    ...
    try {
      _$result = _$v ??
          new _$Matrixdropdowncolumn._(
              ...
              isUnique: isUnique,
              totalFormat: _totalFormat?.build(),
              totalType: totalType,
              totalCurrency: totalCurrency,
              totalDisplayStyle: totalDisplayStyle,
              valueTrue: valueTrue,
              valueFalse: valueFalse,
              labelTrue: _labelTrue?.build(),
              labelFalse: _labelFalse?.build(),
              label: _label?.build(),
              useDisplayValuesInDynamicTexts: useDisplayValuesInDynamicTexts,
              indent: indent,
              valueName: valueName,
              ...
              type: type,
              name: name,
              selectAllText: _selectAllText?.build(),
              ...
              otherText: _otherText?.build(),
              choices: _choices?.build(),
              showNoneItem: showNoneItem,
              otherErrorText: _otherErrorText?.build(),
      ...
      try {
        _$failedField = 'cellHint';
        _cellHint?.build();

        _$failedField = 'totalFormat';
        _totalFormat?.build();

        _$failedField = 'labelTrue';
        _labelTrue?.build();
        _$failedField = 'labelFalse';
        _labelFalse?.build();
        _$failedField = 'label';
        _label?.build();
        ...
        _$failedField = 'selectAllText';
        _selectAllText?.build();

        _$failedField = 'choicesByUrl';
        _choicesByUrl?.build();

        _$failedField = 'noneText';
        _noneText?.build();

        _$failedField = 'otherPlaceholder';
        _otherPlaceholder?.build();

        _$failedField = 'otherText';
        _otherText?.build();
        _$failedField = 'choices';
        _choices?.build();

        _$failedField = 'otherErrorText';
        _otherErrorText?.build();
