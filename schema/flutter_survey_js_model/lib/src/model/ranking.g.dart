...
class _$Ranking extends Ranking {
  @override
  final String? selectToRankEnabled;
  @override
  final String? selectToRankAreasLayout;
  @override
  ...
  factory _$Ranking([void Function(RankingBuilder)? updates]) =>
      (new RankingBuilder()..update(updates))._build();

  _$Ranking._(
      {this.selectToRankEnabled,
      this.selectToRankAreasLayout,
      this.longTap,
      this.selectAllText,
  ...
  @override
  Ranking rebuild(void Function(RankingBuilder) updates) =>
  ...
  bool operator ==(Object other) {
    ...
    return other is Ranking &&
        selectToRankEnabled == other.selectToRankEnabled &&
        selectToRankAreasLayout == other.selectToRankAreasLayout &&
  ...
  int get hashCode {
    var _$hash = 0;
    _$hash = $jc(_$hash, selectToRankEnabled.hashCode);
    _$hash = $jc(_$hash, selectToRankAreasLayout.hashCode);
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'Ranking')
          ..add('selectToRankEnabled', selectToRankEnabled)
          ..add('selectToRankAreasLayout', selectToRankAreasLayout)
          ..add('longTap', longTap)
...
class RankingBuilder
    implements Builder<Ranking, RankingBuilder>, CheckboxBuilder {
  _$Ranking? _$v;

  String? _selectToRankEnabled;
  String? get selectToRankEnabled => _$this._selectToRankEnabled;
  set selectToRankEnabled(covariant String? selectToRankEnabled) =>
      _$this._selectToRankEnabled = selectToRankEnabled;

  String? _selectToRankAreasLayout;
  String? get selectToRankAreasLayout => _$this._selectToRankAreasLayout;
  set selectToRankAreasLayout(covariant String? selectToRankAreasLayout) =>
      _$this._selectToRankAreasLayout = selectToRankAreasLayout;
  ...
  RankingBuilder() {
    Ranking._defaults(this);
  }

  RankingBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _selectToRankEnabled = $v.selectToRankEnabled;
      _selectToRankAreasLayout = $v.selectToRankAreasLayout;
      _longTap = $v.longTap;
  ...
  @override
  void replace(covariant Ranking other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$Ranking;
  }

  @override
  void update(void Function(RankingBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  Ranking build() => _build();
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'Ranking', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
