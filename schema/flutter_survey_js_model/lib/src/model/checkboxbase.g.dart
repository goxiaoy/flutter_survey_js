...
part of 'checkboxbase.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

abstract class CheckboxbaseBuilder implements SelectbaseBuilder {
  void replace(covariant Checkboxbase other);
  void update(void Function(CheckboxbaseBuilder) updates);
...
class _$$Checkboxbase extends $Checkboxbase {
  @override
  ...
  factory _$$Checkboxbase([void Function($CheckboxbaseBuilder)? updates]) =>
      (new $CheckboxbaseBuilder()..update(updates))._build();
  ...
  @override
  $Checkboxbase rebuild(void Function($CheckboxbaseBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  $CheckboxbaseBuilder toBuilder() => new $CheckboxbaseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is $Checkboxbase &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'$Checkboxbase')
...
class $CheckboxbaseBuilder
    implements
        Builder<$Checkboxbase, $CheckboxbaseBuilder>,
        CheckboxbaseBuilder {
  _$$Checkboxbase? _$v;
  ...
  $CheckboxbaseBuilder() {
    $Checkboxbase._defaults(this);
  }

  $CheckboxbaseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  $Checkboxbase build() => _build();

  _$$Checkboxbase _build() {
    _$$Checkboxbase _$result;
    try {
      _$result = _$v ??
          new _$$Checkboxbase._(
              colCount: colCount,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'$Checkboxbase', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
