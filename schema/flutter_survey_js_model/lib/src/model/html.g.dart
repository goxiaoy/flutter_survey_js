...
class _$Html extends Html {
  ...
  factory _$Html([void Function(HtmlBuilder)? updates]) =>
      (new HtmlBuilder()..update(updates))._build();
  ...
  @override
  Html rebuild(void Function(HtmlBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  HtmlBuilder toBuilder() => new HtmlBuilder()..replace(this);
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'Html')
          ..add('html', html)
          ..add(
...
class HtmlBuilder implements Builder<Html, HtmlBuilder>, NonvalueBuilder {
  _$Html? _$v;
  ...
  @override
  void replace(covariant Html other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$Html;
  }

  @override
  void update(void Function(HtmlBuilder)? updates) {
