...
part of 'radiogroup.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

abstract class RadiogroupBuilder implements CheckboxbaseBuilder {
  void replace(covariant Radiogroup other);
  void update(void Function(RadiogroupBuilder) updates);
...
class _$$Radiogroup extends $Radiogroup {
  @override
  ...
  factory _$$Radiogroup([void Function($RadiogroupBuilder)? updates]) =>
      (new $RadiogroupBuilder()..update(updates))._build();
  ...
  @override
  $Radiogroup rebuild(void Function($RadiogroupBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  $RadiogroupBuilder toBuilder() => new $RadiogroupBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is $Radiogroup &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'$Radiogroup')
...
class $RadiogroupBuilder
    implements Builder<$Radiogroup, $RadiogroupBuilder>, RadiogroupBuilder {
  _$$Radiogroup? _$v;
  ...
  $RadiogroupBuilder() {
    $Radiogroup._defaults(this);
  }

  $RadiogroupBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  $Radiogroup build() => _build();

  _$$Radiogroup _build() {
    _$$Radiogroup _$result;
    try {
      _$result = _$v ??
          new _$$Radiogroup._(
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'$Radiogroup', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
