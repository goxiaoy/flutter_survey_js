...
class _$File extends File {
  ...
  bool operator ==(Object other) {
    ...
    return other is File &&
        ...
        allowCameraAccess == other.allowCameraAccess &&
  ...
  int get hashCode {
    ...
    _$hash = $jc(_$hash, allowCameraAccess.hashCode);
  ...
  String toString() {
    return (newBuiltValueToStringHelper(r'File')
          ...
          ..add('allowCameraAccess', allowCameraAccess)
...
class FileBuilder implements Builder<File, FileBuilder>, QuestionBuilder {
  _$File? _$v;
  ...
  bool? _allowCameraAccess;
  bool? get allowCameraAccess => _$this._allowCameraAccess;
  set allowCameraAccess(covariant bool? allowCameraAccess) =>
      _$this._allowCameraAccess = allowCameraAccess;
  ...
  FileBuilder get _$this {
    ...
    if ($v != null) {
      ...
      _allowCameraAccess = $v.allowCameraAccess;
  ...
  @override
  void replace(covariant File other) {
