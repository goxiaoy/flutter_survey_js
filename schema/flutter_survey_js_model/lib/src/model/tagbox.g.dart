...
abstract class TagboxBuilder implements CheckboxBuilder {
  void replace(covariant Tagbox other);
  void update(void Function(TagboxBuilder) updates);
  ...
  bool? get allowClear;
  set allowClear(covariant bool? allowClear);
  ...
  set choices(
      covariant ListBuilder<MatrixdropdownbaseAllOfChoicesInner>? choices);
...
class _$$Tagbox extends $Tagbox {
  ...
  factory _$$Tagbox([void Function($TagboxBuilder)? updates]) =>
      (new $TagboxBuilder()..update(updates))._build();
  ...
  @override
  $Tagbox rebuild(void Function($TagboxBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  $TagboxBuilder toBuilder() => new $TagboxBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is $Tagbox &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'$Tagbox')
...
class $TagboxBuilder
    implements Builder<$Tagbox, $TagboxBuilder>, TagboxBuilder {
  _$$Tagbox? _$v;
  ...
  $TagboxBuilder() {
    $Tagbox._defaults(this);
  }

  $TagboxBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'$Tagbox', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
