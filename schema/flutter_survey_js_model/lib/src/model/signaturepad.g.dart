...
part of 'signaturepad.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$Signaturepad extends Signaturepad {
  @override
  ...
  factory _$Signaturepad([void Function(SignaturepadBuilder)? updates]) =>
      (new SignaturepadBuilder()..update(updates))._build();
  ...
  @override
  Signaturepad rebuild(void Function(SignaturepadBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  SignaturepadBuilder toBuilder() => new SignaturepadBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is Signaturepad &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'Signaturepad')
...
class SignaturepadBuilder
    implements Builder<Signaturepad, SignaturepadBuilder>, QuestionBuilder {
  _$Signaturepad? _$v;
  ...
  SignaturepadBuilder() {
    Signaturepad._defaults(this);
  }

  SignaturepadBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(covariant Signaturepad other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$Signaturepad;
  }

  @override
  void update(void Function(SignaturepadBuilder)? updates) {
