...
part of 'matrixdropdownbase.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

abstract class MatrixdropdownbaseBuilder implements MatrixbaseBuilder {
  ...
  bool? get showHeader;
  set showHeader(covariant bool? showHeader);
...
class _$$Matrixdropdownbase extends $Matrixdropdownbase {
  ...
  factory _$$Matrixdropdownbase(
          [void Function($MatrixdropdownbaseBuilder)? updates]) =>
      (new $MatrixdropdownbaseBuilder()..update(updates))._build();

  _$$Matrixdropdownbase._(
      {this.cellType,
      this.columns,
  ...
  @override
  $Matrixdropdownbase rebuild(
          void Function($MatrixdropdownbaseBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  $MatrixdropdownbaseBuilder toBuilder() =>
      new $MatrixdropdownbaseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is $Matrixdropdownbase &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'$Matrixdropdownbase')
...
class $MatrixdropdownbaseBuilder
    implements
        Builder<$Matrixdropdownbase, $MatrixdropdownbaseBuilder>,
  ...
  $MatrixdropdownbaseBuilder() {
    $Matrixdropdownbase._defaults(this);
  }

  $MatrixdropdownbaseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  void replace(covariant $Matrixdropdownbase other) {
    ...
    _$v = other as _$$Matrixdropdownbase;
  }
  ...
  @override
  $Matrixdropdownbase build() => _build();

  _$$Matrixdropdownbase _build() {
    _$$Matrixdropdownbase _$result;
    try {
      _$result = _$v ??
          new _$$Matrixdropdownbase._(
              cellType: cellType,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'$Matrixdropdownbase', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
