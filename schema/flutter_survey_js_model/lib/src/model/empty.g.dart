...
class _$Empty extends Empty {
  ...
  factory _$Empty([void Function(EmptyBuilder)? updates]) =>
      (new EmptyBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'Empty')
          ..add('type', type)
          ..add('name', name)
          ..add('state', state)
          ..add('visible', visible)
...
class EmptyBuilder implements Builder<Empty, EmptyBuilder>, QuestionBuilder {
  _$Empty? _$v;
  ...
  @override
  void replace(covariant Empty other) {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'Empty', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
