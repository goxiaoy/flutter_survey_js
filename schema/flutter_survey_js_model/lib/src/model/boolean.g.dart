...
abstract class BooleanBuilder implements QuestionBuilder {
  void replace(covariant Boolean other);
  void update(void Function(BooleanBuilder) updates);
  String? get valueTrue;
  set valueTrue(covariant String? valueTrue);
  ...
  SurveyTitleBuilder get label;
  set label(covariant SurveyTitleBuilder? label);
...
class _$$Boolean extends $Boolean {
  ...
  factory _$$Boolean([void Function($BooleanBuilder)? updates]) =>
      (new $BooleanBuilder()..update(updates))._build();
  ...
  @override
  $Boolean rebuild(void Function($BooleanBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  $BooleanBuilder toBuilder() => new $BooleanBuilder()..replace(this);
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'$Boolean')
...
class $BooleanBuilder
    implements Builder<$Boolean, $BooleanBuilder>, BooleanBuilder {
  _$$Boolean? _$v;
  ...
  $BooleanBuilder() {
    $Boolean._defaults(this);
  }

  $BooleanBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'$Boolean', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
