...
part of 'multipletext.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$Multipletext extends Multipletext {
  @override
  ...
  _$Multipletext._(
      ...
      this.name})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(items, r'Multipletext', 'items');
  }
  ...
  @override
  MultipletextBuilder toBuilder() => new MultipletextBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is Multipletext &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'Multipletext')
...
class MultipletextBuilder
    implements Builder<Multipletext, MultipletextBuilder>, QuestionBuilder {
  _$Multipletext? _$v;
  ...
  MultipletextBuilder() {
    Multipletext._defaults(this);
  }

  MultipletextBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(covariant Multipletext other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$Multipletext;
  }

  @override
  void update(void Function(MultipletextBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  Multipletext build() => _build();

  _$Multipletext _build() {
    _$Multipletext _$result;
    try {
      _$result = _$v ??
