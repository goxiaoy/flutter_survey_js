...
class _$Matrix extends Matrix {
  ...
  factory _$Matrix([void Function(MatrixBuilder)? updates]) =>
      (new MatrixBuilder()..update(updates))._build();
  ...
  @override
  Matrix rebuild(void Function(MatrixBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  MatrixBuilder toBuilder() => new MatrixBuilder()..replace(this);
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'Matrix')
          ..add('cells', cells)
...
class MatrixBuilder
    implements Builder<Matrix, MatrixBuilder>, MatrixbaseBuilder {
  _$Matrix? _$v;
  ...
  @override
  void replace(covariant Matrix other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$Matrix;
  }

  @override
  void update(void Function(MatrixBuilder)? updates) {
