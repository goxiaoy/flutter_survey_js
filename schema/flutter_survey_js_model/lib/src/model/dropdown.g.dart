...
abstract class DropdownBuilder implements SelectbaseBuilder {
  void replace(covariant Dropdown other);
  ...
  num? get choicesMin;
  set choicesMin(covariant num? choicesMin);
  ...
  num? get choicesMax;
  set choicesMax(covariant num? choicesMax);
...
class _$$Dropdown extends $Dropdown {
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'$Dropdown')
...
class $DropdownBuilder
    implements Builder<$Dropdown, $DropdownBuilder>, DropdownBuilder {
  _$$Dropdown? _$v;
